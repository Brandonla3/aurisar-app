  ...
  if(screen==="login") return (
    React.createElement('div', { style: {
      ...
      , React.createElement('div', { style: {padding:"14px 20px 0", display:"flex", justifyContent:"flex-start"} }
        , React.createElement('span', { style: {fontSize:".72rem", color:"#a89f94", cursor:"pointer", letterSpacing:".04em"}, onClick: ()=>setScreen("home") }, "\u2190 Back")
      )
      , React.createElement("div", { className:"login-root", style: {flex:1, display:"flex", alignItems:"flex-end", justifyContent:"center", padding:"20px 20px 32px"} }
        , React.createElement("div", { style: {width:"100%", maxWidth:400, display:"flex", flexDirection:"column", alignItems:"center"} }
        /* ── Tagline ── */
        , React.createElement('p', { style: {fontStyle:"italic", textAlign:"center", fontSize:".82rem", lineHeight:1.7, color:"#c4bdb2", maxWidth:300, margin:"0 auto 16px", textShadow:"0 1px 8px rgba(0,0,0,.9)"} }
        ...
        , React.createElement('div', { style: {
            width:"100%",
            background:"linear-gradient(145deg, rgba(45,42,36,.52), rgba(26,24,20,.40))",
            border:"1px solid rgba(196,148,40,.12)",
            borderRadius:18,
            backdropFilter:"blur(24px)",
            WebkitBackdropFilter:"blur(24px)",
            boxShadow:"0 8px 32px rgba(0,0,0,.45), inset 0 1px 0 rgba(180,172,158,.06)",
          ...
          , React.createElement('div', { style: {
            ...
            , React.createElement('span', { style: {fontSize:".52rem", color:"rgba(210,200,185,.55)", letterSpacing:".16em", textTransform:"uppercase", whiteSpace:"nowrap"} }
          ...
          , loginSubScreen==="forgot-pw" && React.createElement(React.Fragment, null
            , React.createElement('div', { style: {fontSize:".72rem",color:"#a89f94",lineHeight:1.6,marginBottom:14,textAlign:"center"} },
              "Enter the email address you used to create your account. We\u2019ll send you a link to reset your password."
            )
            , React.createElement('div', { style: {marginBottom:14} }
              , React.createElement('label', { style: {fontSize:".6rem", color:"#a89f94", letterSpacing:".08em", textTransform:"uppercase", display:"block", marginBottom:5} }, "Email Address")
            ...
            , React.createElement('div', { style: {borderTop:"1px solid rgba(45,42,36,.18)", marginTop:14, paddingTop:12, display:"flex", justifyContent:"space-between", alignItems:"center"} }
              , React.createElement('span', { style: {fontSize:".72rem", color:"#a89f94", cursor:"pointer"},
          ...
          , loginSubScreen==="forgot-username" && React.createElement(React.Fragment, null
            ...
            , React.createElement('div', { style: {marginBottom:14} }
              , React.createElement('label', { style: {fontSize:".6rem", color:"#a89f94", letterSpacing:".08em", textTransform:"uppercase", display:"block", marginBottom:5} }, "Private Account ID")
              , React.createElement('input', {
                  className: "inp",
                  type: "text",
            ...
            , forgotLookupResult && React.createElement('div', { style: {
              ...
              , forgotLookupResult.found
                ? React.createElement(React.Fragment, null,
                    ...
                    React.createElement('div', {style:{fontSize:".58rem",color:"#a89f94",marginTop:6}}, "Use this email on the password reset screen."),
                    React.createElement('button', {
            ...
            , React.createElement('div', { style: {background:"rgba(45,42,36,.12)",border:"1px solid rgba(45,42,36,.18)",borderRadius:9,padding:"14px",marginTop:14,textAlign:"center"} }
              , React.createElement('div', {style:{fontSize:".68rem",color:"#a89f94",marginBottom:4}}, "Can\u2019t remember your Private ID either?")
              , React.createElement('div', {style:{fontSize:".62rem",color:"#8a8478",lineHeight:1.5}},
          ...
          , React.createElement('div', { style: {marginBottom:13} }
            , React.createElement('div', { style: {display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:5} }
              , React.createElement('label', { style: {fontSize:".6rem", color:"#a89f94", letterSpacing:".08em", textTransform:"uppercase", margin:0} }
                , authIsNew ? "Create Password" : "Password"
              )
              , React.createElement('span', {
                  style: {fontSize:".6rem", color:"#8a8478", cursor:"pointer", letterSpacing:".04em"},
          ...
          , React.createElement('div', { style: {display:"flex", alignItems:"center", gap:9, cursor:"pointer", marginBottom:16}, onClick: ()=>setAuthRemember(r=>!r) }
            ...
            , React.createElement('span', { style: {fontSize:".72rem", color:"#8a8478", userSelect:"none"} }, "Remain logged in for 30 days")
          )
          ...
          , React.createElement('div', { style: {borderTop:"1px solid rgba(45,42,36,.18)", marginTop:14, paddingTop:12, display:"flex", justifyContent:"space-between", alignItems:"center"} }
            , !authIsNew
              ...
              : React.createElement('span', { style: {fontSize:".72rem", color:"#a89f94", cursor:"pointer"}, onClick: ()=>{setAuthIsNew(false);setAuthMsg(null);setAuthPassword("");} }, "\u2190 Back to Sign In")
            , !authIsNew && React.createElement('span', { style: {fontSize:".72rem", color:"#8a8478", cursor:"pointer"}, onClick: ()=>{setLoginSubScreen("forgot-pw");setAuthMsg(null);setForgotPwEmail("");} }, "Forgot password?")
          )
...
/* Preview mode — PIN-gated dev access */
          , React.createElement('div', { style: {borderTop:"1px solid rgba(45,42,36,.12)", marginTop:6, paddingTop:10, textAlign:"center"} }
            , !showPreviewPin && React.createElement('span', {
                style: {fontSize:".55rem", color:"#6a645a", cursor:"pointer", fontStyle:"italic", letterSpacing:".03em"},
                onClick: ()=>{
            ...
            , showPreviewPin && React.createElement('div', null
              , React.createElement('div', { style: {fontSize:".55rem", color:"#8a8478", marginBottom:6} }, "Enter dev PIN")
              ...
              , React.createElement('span', { style: {fontSize:".5rem", color:"#6a645a", cursor:"pointer", display:"inline-block", marginTop:6}, onClick: ()=>{setShowPreviewPin(false);setPreviewPinError(false);} }, "Cancel")
            )
            , !showPreviewPin && React.createElement('div', { style: {fontSize:".5rem", color:"#5a5650", marginTop:2} }, "Dev access only")
          )
