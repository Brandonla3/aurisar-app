...
<!-- GENERATED:asset-packs START -->

### Runtime asset packs (generated by scripts/assets_pipeline.mjs)

| Category | Source | Author | License |
|---|---|---|---|
| `characters` | MPFB / MakeHuman-derived base bodies + Blender-authored modular pieces | project (CC0 base) + Quaternius/Kenney kit pieces | CC0-1.0 |
| `models` | Meshy AI generation, merged per-clip via scripts/build_gilded_sentinel.mjs | project | CC0-1.0 |
| `mobs` | Animated creatures (Quaternius) + KayKit skeletons | Quaternius, Kay Lousberg | CC0-1.0 |
| `props` | Medieval Village / Fantasy Props / Nature / Pirate kits | Quaternius, Kenney | CC0-1.0 |

<!-- GENERATED:asset-packs END -->
